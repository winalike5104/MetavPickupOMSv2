...
import { handleFirestoreError, OperationType, hasPermission, isAdmin, isSystemAdmin } from '../utils';
import { 
  Users, 
  Plus, 
  Edit2, 
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage groups for targeted notifications</p>
        </div>
        {canManage && (
          <button 
            onClick={() => openModal()}
