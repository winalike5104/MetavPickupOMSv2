        ...
        <div className="px-4 md:px-8">
          <div className="flex justify-between items-center">
            <div className="transition-all duration-300">
              <h1 className={cn(
                "font-bold text-slate-900 flex items-center gap-3 transition-all duration-300",
                isScrolled ? "text-lg md:text-xl" : "text-2xl",
                "group-hover:text-2xl"
              )}>
                <Users className={cn("text-indigo-600 transition-all", isScrolled ? "w-6 h-6" : "w-8 h-8", "group-hover:w-8 group-hover:h-8")} />
                User Groups
              </h1>
              <p className={cn(
                ...
                Manage groups for targeted notifications
              </p>
            </div>
            {canManage && (
              <button 
                onClick={() => openModal()}
                className={cn(
                  "bg-indigo-600 text-white rounded-xl font-bold flex items-center gap-2 hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200",
