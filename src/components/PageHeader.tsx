...
export const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  return (
    <header className={cn(
      ...
      <div className={cn(
        "mx-auto px-4 md:px-8 transition-all duration-300 ease-in-out",
        maxWidth,
        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-4">
            ...
            {Icon && (
              <div className={cn(
                "w-12 h-12 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center transition-all duration-300",
